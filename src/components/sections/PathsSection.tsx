...
const defaultPaths = [
  { id: "tengri", title: "The SAMPO System", subtitle: "Tengri — Sky Father", description: "The foundational energy mastery system. Learn to accumulate, protect, and direct your vital force using ancient Siberian techniques passed down from the celestial realms.", video: "/paths/Tengri 2.mp4", link: "/teachings", color: "#C9A04A", number: "01" },
  { id: "umai", title: "Sacred Healing", subtitle: "Umai — Earth Mother", description: "Private shamanic healing sessions rooted in the nurturing wisdom of Umai. Soul retrieval, energy clearing, and deep ancestral healing for those ready to transform.", video: "/paths/Umai 1.mp4", link: "https://calendly.com/hurraymangalam/individualsessions", color: "#E8CD7A", number: "02" },
  { id: "ulgen", title: "Shamanic Training", subtitle: "Ulgen — Spirit of Light", description: "A structured path to becoming a practitioner. Level 1 certification through intensive residential immersions, drum journeying, and ceremonial leadership.", video: "/paths/Ulgen 2.mp4", link: "/events", color: "#8B7E6E", number: "03" },
  { id: "erlik", title: "Shadow & Ancestral Work", subtitle: "Erlik — Lord of Depths", description: "Deep transformational work for those ready to face the shadow. Ancestral lineage healing, soul fragment recovery, and karmic release through guided ceremonies.", video: "/paths/Erlik 2.mp4", link: "/teachings", color: "#A07D2E", number: "04" },
];
...
function PathCard({ path, index }: { path: any; index: number }) {
  ...
  return (
    <motion.div ref={cardRef} initial={{ opacity: 0, y: 60 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }}
      ...
      <video ref={videoRef} src={path.video || path.previewVideo} loop muted playsInline preload="none"
