...
const reels = [
  { src: "/IMG_1651.MOV", label: "Shamanic Ceremony", platform: "Instagram" as const, views: "24K", duration: "0:58", link: "https://www.instagram.com/earthforpeace/" },
  { src: "/IMG_1652.MOV", label: "Healing Ritual Fire", platform: "Instagram" as const, views: "18K", duration: "1:12", link: "https://www.instagram.com/earthforpeace/" },
  { src: "/IMG_1651.MOV", label: "SAMPO Teaching", platform: "YouTube" as const, views: "41K", duration: "2:34", link: "https://www.youtube.com/@earthforpeace" },
  { src: "/IMG_1652.MOV", label: "Sacred Drum Journey", platform: "Instagram" as const, views: "31K", duration: "0:47", link: "https://www.instagram.com/earthforpeace/" },
  { src: "/IMG_1651.MOV", label: "Nature Synchronization", platform: "YouTube" as const, views: "19K", duration: "1:55", link: "https://www.youtube.com/@earthforpeace" },
];

function ReelCard({ reel, index, shouldReduce }: { reel: (typeof reels)[0]; index: number; shouldReduce: boolean | null }) {
  ...
  return (
    <motion.a
      ...
      style={{
        ...
        display: "block",
        textDecoration: "none",
        boxShadow: hovered ? "0 28px 72px rgba(0,0,0,0.5), 0 0 0 1px rgba(201,160,74,0.2)" : "0 8px 32px rgba(0,0,0,0.2)",
    ...
    >
      ...
      <div style={{
        position: "absolute",
        inset: 0,
        background: "linear-gradient(to top, rgba(31,27,22,0.9) 0%, rgba(31,27,22,0.1) 55%, rgba(31,27,22,0.15) 100%)",
  ...
  return (
    <section style={{ background: "#F5F1EA", overflow: "hidden", position: "relative", marginTop: "-1px", zIndex: 20 }}>
      <div style={{
        ...
        width: "60%",
        height: "40%",
        background: "radial-gradient(ellipse, rgba(201,160,74,0.06) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
        ...
        >
          <div>
            ...
            <h2 style={{
              ...
              Sacred Moments.
              <br />
              <span style={{ fontStyle: "italic", color: "rgba(31,27,22,0.2)" }}>Witnessed.</span>
            </h2>
          </div>
      ...
      <style>{`
        .reel-header { display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: clamp(40px, 6vh, 64px); flex-wrap: wrap; gap: 24px; }
        .reel-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: clamp(10px, 1.2vw, 16px); }
        @media (max-width: 1100px) { .reel-grid { grid-template-columns: repeat(3, 1fr); } }
        @media (max-width: 680px) { .reel-grid { grid-template-columns: repeat(2, 1fr); } .reel-header { flex-direction: column; align-items: flex-start; } }
        @media (max-width: 420px) { .reel-grid { grid-template-columns: 1fr 1fr; gap: 10px; } }
      `}</style>
    </section>
  );
}
