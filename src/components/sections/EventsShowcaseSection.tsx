    ...
    <section id="events" style={{ background: "#F5F1EA", overflow: "hidden", position: "relative" }}>
        ...
        >
          <div>
            ...
            <h2 style={{
              ...
              Join Abhay
              <br />
              <span style={{ fontStyle: "italic", color: "#C9A04A" }}>in the Field.</span>
            </h2>
          </div>
          <p style={{
            ...
            Intimate gatherings designed for real transformation. No performance — only depth, ceremony, and direct energetic healing.
          </p>
        </motion.div>
          ...
          {events.map((ev, i) => (
            <motion.div
              ...
              style={{
                ...
                overflow: "hidden",
                background: "#FDFCFA",
                boxShadow: "0 12px 40px rgba(31,27,22,0.04)",
                border: "1px solid rgba(31,27,22,0.04)",
              }}
            >
              <div className="event-card-grid" style={{
                display: "grid",
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <Link
                        ...
                        style={{
                          ...
                          borderRadius: 2,
                          textDecoration: "none",
                          boxShadow: "0 6px 24px rgba(31,27,22,0.12)",
                          transition: "all 0.3s ease",
                        }}
                      >
                        Register
                        <svg width="12" height="9" viewBox="0 0 14 8" fill="none">
                          <path d="M1 4h12M10 1l3 3-3 3" stroke="#C9A04A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </Link>
                    </div>
                  </div>
                ...
                <div className="event-card-image" style={{
                  ...
                  <Image src={ev.img} alt={ev.title} fill style={{ objectFit: "cover" }} sizes="420px" />
                  <div style={{
                    position: "absolute",
                    inset: 0,
                    background: `linear-gradient(135deg, ${ev.color}10, rgba(31,27,22,0.2))`,
                  }} />
                  <div style={{
                    position: "absolute",
                    bottom: 16,
      ...
      <style>{`
        @media (max-width: 1024px) {
          ...
          .event-card-image { order: 1 !important; min-height: 260px !important; }
          .event-card-content { order: 2 !important; padding: 36px 28px !important; }
        }
        @media (max-width: 768px) {
          .events-wrapper { padding: 60px 20px !important; }
          .event-card-content { padding: 28px 18px !important; }
        }
        .event-btn:hover {
          transform: translateY(-2px);
          box-shadow: 0 12px 32px rgba(31,27,22,0.2) !important;
        }
      `}</style>
    </section>
  );
